...
namespace XRMultiplayer
{
    ...
    public class VoiceChatManager : MonoBehaviour
    {
        ...
        void ConnectedToGame(bool connected)
        {
            ...
            if (connected)
            {
                Login(XRINetworkGameManager.AuthenicationId, XRINetworkGameManager.Instance.sessionManager.currentSession.Id);
            }
            else
            {
                LogOut();
        ...
        async void Login(string displayName, string roomCode)
        {
